...
model2 = Sequential()
model2.add(LSTM(128, activation='relu', input_shape=(X_train_eda.shape[1], X_train_eda.shape[2]), return_sequences=True, dropout=0.3))
...
combined_model = compiled_tcn(
    ...
    datasets=[X_train_eye, X_train_eda],
    num_feat=1,
    max_len=1,
    num_classes=0,
    nb_filters=24,
