...
model1.add(Bidirectional(forward_layer, backward_layer=backward_layer, input_shape=(X_train_eye.shape[1], X_train_eye.shape[2])))
...
forward_layer = LSTM(128, return_sequences=True)
backward_layer = LSTM(128, activation='relu', return_sequences=True, go_backwards=True)
model2.add(Bidirectional(forward_layer, backward_layer=backward_layer, input_shape=(X_train_head.shape[1], X_train_head.shape[2])))
...
forward_layer = LSTM(128, return_sequences=True)
backward_layer = LSTM(128, activation='relu', return_sequences=True, go_backwards=True)
model3.add(Bidirectional(forward_layer, backward_layer=backward_layer, input_shape=(X_train_eda.shape[1], X_train_eda.shape[2])))
model3.add(LSTM(128, activation='relu', return_sequences=True, dropout=0.3))
...
model4.add(LSTM(128, activation='relu', return_sequences=True, dropout=0.3))
