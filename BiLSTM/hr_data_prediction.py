...
model.add(Bidirectional(forward_layer, backward_layer=backward_layer, input_shape=(X_train_hr.shape[1], X_train_hr.shape[2])))
model.add(LSTM(64, activation='relu',  return_sequences=True, dropout=0.3))
