...
model = Sequential()
model.add(GRU(64, activation='relu', input_shape=(X_train_hr.shape[1], X_train_hr.shape[2]), return_sequences=True, dropout=0.3))
model.add(GRU(32, activation='relu', return_sequences=True, dropout=0.5))
model.add(GRU(32, activation='relu', return_sequences=True, dropout=0.5))
model.add(GRU(16, activation='relu', return_sequences=True, dropout=0.5))
model.add(GRU(10, activation='relu', return_sequences=False, dropout=0.5))
