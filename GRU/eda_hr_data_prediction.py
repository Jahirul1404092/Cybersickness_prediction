...
model1 = Sequential()
model1.add(GRU(128, activation='relu', input_shape=(X_train_eda.shape[1], X_train_eda.shape[2]), return_sequences=True, dropout=0.3))
...
model2 = Sequential()
model2.add(GRU(128, activation='relu', input_shape=(X_train_hr.shape[1], X_train_hr.shape[2]), return_sequences=True, dropout=0.3))
