...
model2 = Sequential()
model2.add(GRU(128, activation='relu', input_shape=(X_train_head.shape[1], X_train_head.shape[2]), return_sequences=True, dropout=0.3))
...
model3 = Sequential()
model3.add(GRU(128, activation='relu', input_shape=(X_train_eda.shape[1], X_train_eda.shape[2]), return_sequences=True, dropout=0.3))
model3.add(GRU(64, activation='relu', return_sequences=True, dropout=0.5))
model3.add(GRU(32, activation='relu', return_sequences=True, dropout=0.5))
model3.add(GRU(32, activation='relu', return_sequences=True, dropout=0.5))
model3.add(GRU(16, activation='relu', return_sequences=True, dropout=0.5))
#model1.add(GRU(10, activation='relu', return_sequences=False, dropout=0.5))
#model1.add(Dense(10))
#model1.add(Dense(Y_train_eye.shape[1]))
model3.summary()
...
model4 = Sequential()
model4.add(GRU(128, activation='relu', input_shape=(X_train_hr.shape[1], X_train_hr.shape[2]), return_sequences=True, dropout=0.3))
model4.add(GRU(64, activation='relu', return_sequences=True, dropout=0.5))
model4.add(GRU(32, activation='relu', return_sequences=True, dropout=0.5))
model4.add(GRU(32, activation='relu', return_sequences=True, dropout=0.5))
model4.add(GRU(16, activation='relu', return_sequences=True, dropout=0.5))
#model2.add(GRU(10, activation='relu', return_sequences=False, dropout=0.5))
#model2.add(Dense(10))
#model2.add(Dense(Y_train_head.shape[1]))
model4.summary()
